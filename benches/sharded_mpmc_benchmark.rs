...
fn benchmark(c: &mut Criterion) {
    ...
    // ==================== PUSH LATENCY ====================
    let mut group = make_group(c, "sharded_mpmc/push_latency");
    ...
    {
        let mut group = make_group(c, "sharded_mpmc/throughput/payload_8");
    ...
    // Throughput for 1024-byte payload
    {
        ...
        let mut group = make_group(c, "sharded_mpmc/throughput/payload_1024");
        group.throughput(Throughput::ElementsAndBytes {
